...
How to Update the Browser Extension:
    ...
    Google Chrome:
        ...
        In the Extensions page, click the Update button to automatically update all extensions, including LastPass.
    ...
    Mozilla Firefox:
        ...
        If an update is available for the LastPass extension, it will show here. You can also enable automatic updates for extensions.

    Safari:

        Open Safari and click Safari in the top menu, then select Preferences.

        Go to the Extensions tab, and if there’s an update available for LastPass, it will show up here. You can update from the Mac App Store if needed.
...
How to Clear Cache and Cookies:
    ...
    Mozilla Firefox:
        ...
        Click the three horizontal lines in the top-right corner and go to Options.
...
How to Reinstall the Browser Extension:
    ...
    Remove the Extension:
        ...
        Find LastPass and click the Remove or Uninstall option.

    Reinstall the Extension:

        Go to the Chrome Web Store (for Chrome) or Firefox Add-ons (for Firefox) and search for the LastPass extension.

        Install it again, and log in with your LastPass credentials.

How to Reinstall the Mobile App:

    Uninstall the App:

        On your device, press and hold the LastPass app icon and choose Uninstall or Delete.

    Reinstall the App:

        Visit the App Store or Google Play Store, search for LastPass, and reinstall it.

        Log in to your account, and check if the problem is fixed.
